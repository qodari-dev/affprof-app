    ...
    changeSections: [
      {
        ...
        items: [
          ...
          'Old links shared with the custom domain stop working once the domain is no longer active in AffProf, even if DNS records still exist.',
      ...
      },
      {
        ...
        items: [
          ...
          'Click Verify.',
          'During a transition, the old subdomain can keep working only while its DNS records and verified AffProf domain setup remain active.',
        ],
      },
    ],
    ...
    changeSections: [
      {
        ...
        items: [
          ...
          'Los links viejos compartidos con el dominio personalizado dejan de funcionar cuando el dominio ya no está activo en AffProf, incluso si los registros DNS todavía existen.',
      ...
      },
      {
        ...
        items: [
          ...
          'Haz clic en Verify.',
          'Durante una transición, el subdominio viejo puede seguir funcionando solo mientras sus registros DNS y la configuración verificada en AffProf sigan activos.',
        ],
      },
    ],
