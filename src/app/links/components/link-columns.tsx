...
export function useLinkColumns(): ColumnDef<Links>[] {
  const tc = useTranslations('links.columns');
  const locale = useLocale();

  return [
    {
      accessorKey: 'slug',
      header: ({ column }) => <DataTableColumnHeader column={column} title={tc('slug')} />,
      cell: ({ row }) => (
    ...
    },
    {
      ...
      header: ({ column }) => <DataTableColumnHeader column={column} title={tc('platform')} />,
      cell: ({ row }) => (
    ...
    },
    {
      ...
      header: ({ column }) => <DataTableColumnHeader column={column} title={tc('clicks')} />,
      cell: ({ row }) => (
